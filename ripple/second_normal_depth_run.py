...
def main(
    ...
    rm = RasManager(ras_project_text_file, version=version, terrain_name=terrain_name, projection=projection)
...
if __name__ == "__main__":
    ...
    main(nwm_id, ripple_parameters[nwm_id], ras_project_text_file, subset_gpkg_path, terrain_name)

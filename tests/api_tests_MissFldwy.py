...
REACH_ID = "2930557"
SOURCE_RAS_MODEL_DIRECTORY = os.path.join(TEST_DIR, "ras-data\\MissFldwy")
SUBMODELS_BASE_DIRECTORY = os.path.join(TEST_DIR, "ras-data\\MissFldwy\\submodels")
...
DEPTH_GRIDS_KWSE = os.path.join(SUBMODELS_BASE_DIRECTORY, f"{REACH_ID}\\fims\\z_455_0")
